package com.xtan.tanglanqin.tlame.helper;
...
import com.xtan.tanglanqin.tlame.XtanApplication;
import com.xtan.tanglanqin.tlame.lame.Lame;
import com.xtan.tanglanqin.tlame.lame.LameAsyncEncoder;
import com.xtan.tanglanqin.tlame.lame.LameOutputStream;
    ...
    */
    ...
    public File record() {
        ...
        if ((audioRecorder = initAudioRecord()) == null
            ...
            Toast.makeText(XtanApplication.getInstance(), "Record init error!", Toast.LENGTH_SHORT).show();
            return null;
        }
