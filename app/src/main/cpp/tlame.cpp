...
Java_com_xtan_tanglanqin_tlame_lame_Lame_nInit(JNIEnv *env, jclass type, jint inSampleRate, jint inChannels,
...
Java_com_xtan_tanglanqin_tlame_lame_Lame_nGetVersion(JNIEnv *env, jclass type, jlong lamePtr) {
    lame_global_flags *lameFlags;
...
JNIEXPORT jint JNICALL
Java_com_xtan_tanglanqin_tlame_lame_Lame_mGetMp3bufferSize(JNIEnv *env, jclass type, jlong lamePtr) {
    lame_global_flags *lameFlags;
    lameFlags = (lame_global_flags *) lamePtr;
...
JNIEXPORT jint JNICALL
Java_com_xtan_tanglanqin_tlame_lame_Lame_mGetMp3bufferSizeWithSamples(JNIEnv *env, jclass type, jlong lamePtr,
                                                        jint samples) {
...
JNIEXPORT jint JNICALL
Java_com_xtan_tanglanqin_tlame_lame_Lame_nEncodeShortInterleaved(JNIEnv *env, jclass type, jlong lamePtr,
...
JNIEXPORT jint JNICALL
Java_com_xtan_tanglanqin_tlame_lame_Lame_nEncodeShort(JNIEnv *env, jclass type, jlong lamePtr, jshortArray bufL_,
...
JNIEXPORT jint JNICALL
Java_com_xtan_tanglanqin_tlame_lame_Lame_nFlush(JNIEnv *env, jclass type, jlong lamePtr, jbyteArray outBuf_) {
...
Java_com_xtan_tanglanqin_tlame_lame_Lame_nClose(JNIEnv *env, jclass type, jlong lamePtr) {
    lame_global_flags *lameFlags;
    lameFlags = (lame_global_flags *) lamePtr;
    lame_close(lameFlags);
}